import { WHATSAPP_URL, EMAIL, SOCIAL_INSTAGRAM, SOCIAL_LINKEDIN, SOCIAL_FACEBOOK } from '@/config'
...
const SOCIAL = [
  { href: SOCIAL_INSTAGRAM, label: 'Instagram', rel: 'noopener noreferrer', icon: 'instagram' },
  { href: SOCIAL_LINKEDIN, label: 'LinkedIn', rel: 'noopener noreferrer', icon: 'linkedin' },
  { href: SOCIAL_FACEBOOK, label: 'Facebook', rel: 'noopener noreferrer', icon: 'facebook' },
]
      ...
      <div className="container">
        <div className="footer-top">
          ...
          <div className="footer-contact">
            ...
            <span className="footer-contact-note">We reply within 24 hours</span>
          </div>
        </div>
